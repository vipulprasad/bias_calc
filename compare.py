...
def compare(file1):
        ...
        data1 = np.loadtxt('bias_plots_0.01-30/bias_files/'+file1)
        data2 = np.loadtxt('bias_plots_0.01-30/bias_files/bias_{}_{}.txt'.format(bin1, bin1))
        data3 = np.loadtxt('bias_plots_0.01-30/bias_files/bias_{}_{}.txt'.format(bin2, bin2))
        ...
        plt.legend()
        plt.savefig('bias_plots_0.01-30/bias_compare_{}_{}.png'.format(bin1, bin2))
        #plt.show()
        plt.close()

file_names = open('bias_files.txt', 'r').readlines()
